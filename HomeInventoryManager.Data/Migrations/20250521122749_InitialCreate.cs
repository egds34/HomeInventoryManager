        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    refresh_token_time = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    first_name = table.Column<string>(type: "text", nullable: false),
                    last_name = table.Column<string>(type: "text", nullable: false),
                    role = table.Column<string>(type: "text", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    last_login_time = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    last_login_attempt_time = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    failed_login_attempts = table.Column<int>(type: "integer", nullable: false),
                    lockout_until_time = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    total_lockouts = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
